...
This step establishes the **data layer foundation** for the Spendsphere application.
...
- Opens connection to `spendsphere.db` (or `expense_tracker.db`) in project root
- Sets:
